      ...
      <van-row>
        ...
        <van-col span="20">
          <van-row type="flex" justify="space-between">
            ...
            <van-col span="4">
              <br>
              <font size="1" @click="login">点击登录></font>
            </van-col>
          </van-row>
        </van-col>
      </van-row>
    ...
    <van-overlay :show="account" @click="setting = account">
      <div class="wrapper" @click.stop>
        <div class="block">
          ...
          <van-row>
            <van-col span="2">
              <van-icon name="arrow-left" size="25" @click="account = false"/>
            </van-col>
            <van-col span="20">账户</van-col>
            <van-col span="2"></van-col>
          </van-row>
          <van-divider/>
          <van-cell-group inset>
            <h2>{{user.yue}}</h2>
            <font size="1">充值币&nbsp;0.00 &nbsp;&nbsp;|&nbsp;&nbsp;赠币&nbsp;1.00</font>
            <br>
            <br>
...
export default {
  created: function() {
    this.$axios
      .get("adminload?usertel=" + localStorage.getItem("usertel"))
      .then(res => {
